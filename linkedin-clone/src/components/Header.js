    ...
    <Container>
      <Content>
        ...
        <Search>
          ...
          <SearchIcon>
            <img src="/images/icons/search-icon.svg" alt="search icon"></img>
          </SearchIcon>
        </Search>
        <Nav>
          <nav>
              ...
              <NavLink to="/home">
                <svg xmlns="http://www.w3.org/2000/svg" width="25.719" height="20" viewBox="0 0 25.719 20">
                  <path
                    ...
                    d="M12.518,7.442l-8.232,6.78v7.317A.714.714,0,0,0,5,22.254l5-.013a.714.714,0,0,0,.711-.714V17.253a.714.714,0,0,1,.714-.714h2.857a.714.714,0,0,1,.714.714v4.27a.714.714,0,0,0,.714.717l5,.014a.714.714,0,0,0,.714-.714V14.217L13.2,7.442A.544.544,0,0,0,12.518,7.442Zm13,4.608L21.788,8.973V2.789a.536.536,0,0,0-.536-.536h-2.5a.536.536,0,0,0-.536.536V6.031l-4-3.289a2.143,2.143,0,0,0-2.724,0L.193,12.05a.536.536,0,0,0-.071.755L1.26,14.189a.536.536,0,0,0,.755.073l10.5-8.65a.544.544,0,0,1,.683,0l10.5,8.65a.536.536,0,0,0,.755-.071L25.6,12.806a.536.536,0,0,0-.076-.756Z"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="29.762" height="23.5" viewBox="0 0 29.762 23.5">
                  <g id="Group_592" data-name="Group 592" transform="translate(-101.119 -13)">
                    <path
                      ...
                      d="M29.208,22.919a1.71,1.71,0,0,0-2.2,0l-4.774,3.818a3.289,3.289,0,0,1-2.067.723H14.054a.827.827,0,0,1,0-1.653H18.1a1.72,1.72,0,0,0,1.721-1.374A1.655,1.655,0,0,0,18.187,22.5H9.92a6.081,6.081,0,0,0-3.829,1.359l-2.4,1.948H.827A.829.829,0,0,0,0,26.633v4.96a.829.829,0,0,0,.827.827H19.262a3.311,3.311,0,0,0,2.067-.723l7.812-6.252A1.653,1.653,0,0,0,29.208,22.919Z"
                      transform="translate(101.119 4.08)"
                      fill="#c3c3c3"
                    />
                    <text id="NGO" transform="translate(109 22)" fill="#c3c3c3" font-size="9" font-family="Poppins-Regular, Poppins">
                      <tspan x="0" y="0">
                        NGO
                      </tspan>
                    </text>
              ...
              <NavLink to="/mynetwork">
                <svg xmlns="http://www.w3.org/2000/svg" width="31.111" height="20" viewBox="0 0 31.111 20">
                  <path
                    ...
                    d="M23.462,16.208a4.167,4.167,0,1,0-4.242-4.167A4.218,4.218,0,0,0,23.462,16.208Zm-11.313,0a4.167,4.167,0,1,0-4.243-4.167A4.218,4.218,0,0,0,12.149,16.208Zm0,3.056c-3.323,0-9.9,1.6-9.9,4.861v3.75h20v-3.75C22.25,20.861,15.472,19.264,12.149,19.264Zm11.313.764a7.547,7.547,0,0,0-1.212.069c1.627,1.181,2.222,1.944,2.222,4.028v3.75h8.889v-3.75C33.361,20.861,26.786,20.028,23.462,20.028Z"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="18.389" height="23" viewBox="0 0 18.389 23">
                  <g id="Icon_ionic-ios-notifications" data-name="Icon ionic-ios-notifications" transform="translate(0)">
                    ...
                    <path
                      id="Path_352"
                      data-name="Path 352"
                      d="M24.917,20.129c-.885-1.11-2.627-1.76-2.627-6.73,0-5.1-2.368-7.151-4.576-7.643-.207-.049-.356-.115-.356-.323V5.275a1.4,1.4,0,0,0-2.805,0v.159c0,.2-.149.273-.356.323C11.983,6.254,9.62,8.3,9.62,13.4c0,4.97-1.742,5.615-2.627,6.73a1.083,1.083,0,0,0,.914,1.739h16.1A1.082,1.082,0,0,0,24.917,20.129Z"
                      transform="translate(-6.761 -3.93)"
                      fill="rgba(112,112,112,0.42)"
                    />
                  </g>
                </svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 31.812 31.812">
                  <g id="Group_474" data-name="Group 474" transform="translate(-1650 -29)">
                    <path
                      ...
                      d="M36.312,19.522a14.81,14.81,0,0,1-1.591,6.716A15.022,15.022,0,0,1,21.29,34.545a14.81,14.81,0,0,1-6.716-1.591L4.5,36.312,7.858,26.238a14.81,14.81,0,0,1-1.591-6.716A15.022,15.022,0,0,1,14.574,6.091,14.81,14.81,0,0,1,21.29,4.5h.884A14.987,14.987,0,0,1,36.312,18.639Z"
                      transform="translate(1645.5 24.5)"
                      fill="#c3c3c3"
                    />
