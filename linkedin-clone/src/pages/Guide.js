    ...
    <Container>
      ...
      <GuideContainer>
        ...
        <div>
            ...
            <p>This page has been created for a reason, to connect non-profit organizations who are working with Eramus+ all around the world with each other for collaborations, as well as volunteers who would like to attend in different projects and would like to fond and connect with like-minded people.</p>
        </div>
        ...
        <img src="/images/icons/colors.svg" alt=""/>
        </InfoGuide2>

        <InfoGuide>
        <div>
            <h3>What can you use it for?</h3>
            <p>This platform is not just connect people and organizations, but also gives opportunity to match volunteers with the right program for them. In each project description there are keywords, what is it about, so the volunteers can easily find the project that fits for them. It's working also in the other way, as the volunteers can give the topics that they are interested in, so the NGOs can match them with their projects.  </p>
        </div>
        <img src="/images/icons/networking.svg" alt=""/>
        </InfoGuide>
        ...
        <img src="/images/icons/culture.svg" alt=""/>
        </InfoGuide2>
